...
print('Melting dataframe dengan id_vars, value_vars, var_name, value_name:\n', data_melt_4)
# %% [markdown]
# __Stack & Unstack - Part 1__
# %%
import pandas as pd
data = pd.DataFrame({
    'kelas': 6*['A'] + 6*['B'],
...
# %% [markdown]
# __Groupby dan Aggregasi dengan Fungsi Statistik Dasar - Part 1__
# %%
import pandas as pd
# Load data global_air_quality.csv
...
# %% [markdown]
# __Groupby dengan Multiple Aggregations__
# %%
import pandas as pd
...
# %% [markdown]
# __Groupby dengan Custom Aggregations__
# %%
import pandas as pd
# Load data https://storage.googleapis.com/dqlab-dataset/LO4/global_air_quality_4000rows.csv
gaq = pd.read_csv('https://storage.googleapis.com/dqlab-dataset/LO4/global_air_quality_4000rows.csv')
...
# %% [markdown]
# __Groupby dengan Custom Aggregations by dict__
# %%
import pandas as pd
# Load data https://storage.googleapis.com/dqlab-dataset/LO4/global_air_quality_4000rows.csv
gaq = pd.read_csv('https://storage.googleapis.com/dqlab-dataset/LO4/global_air_quality_4000rows.csv')
...
# %% [markdown]
# __Load Dataset as Time Series__
# %%
import pandas as pd
# Load data https://storage.googleapis.com/dqlab-dataset/LO4/global_air_quality_4000rows.csv
...
line1.plot(
    ...
    subplots = True #memecah plot menjadi beberapa bahan sesuai dengan jumlah kolom
)
